...
const PACKS = {
  ...
  "pack-matiere-penal-general-l1": { nom: "Pack Droit pénal général L2 complet (fiche + flashcards + arrêts + cas pratique)", composants: ["fiche-penal-general-l1", "flashcards-qcm-penal-general-l1", "fiche-arret-penal", "cas-pratique-penal-general-l1"] },
