...
async function envoyerConfirmationStage(email, metadata, brevoKey) {
  ...
  const paragraphes = [
    ...
    "La première séance aura lieu le mardi 8 septembre, de 17 h à 20 h. Nous travaillerons la structure complète de la fiche d'arrêt, notamment la différence entre un arrêt de rejet et un arrêt de cassation, puis la méthode du commentaire d'arrêt : introduction, construction du plan et rédaction des sous-parties.",
    "La deuxième séance se déroulera le mercredi 9 septembre, de 17 h à 20 h. Nous corrigerons un commentaire d'arrêt de A à Z, puis nous travaillerons la méthode du cas pratique : construction précise de la majeure, application de chaque condition aux faits et rédaction de la solution.",
    "Enfin, la troisième séance aura lieu le jeudi 10 septembre, de 17 h à 19 h. Nous commencerons par la correction complète d'un cas pratique, puis nous étudierons la méthode de la dissertation juridique : recherche du plan, construction de la problématique et rédaction de l'introduction.",
