    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;">
        ...
        <tr><td style="padding:32px;">
          ...
          <p style="font-size:13px;color:#777;margin:0 0 24px;">
            Ces mises à jour sont automatiques. N'hésite pas à revenir régulièrement sur ton <a href="https://trajectoiredroit.com/mon-compte.html" style="color:#1a237e;">espace Mon compte</a> pour retélécharger le même format que tu as déjà acheté. Tu profites ainsi de la dernière version sans rien payer de plus.
          </p>
          <p style="font-size:13px;color:#777;margin:0 0 24px;">
