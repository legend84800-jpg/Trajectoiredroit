    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;">
        ...
        <tr><td style="padding:32px;">
          ...
          <p style="font-size:13px;color:#777;margin:0 0 24px;">
            Ces mises à jour sont automatiques, environ toutes les deux semaines. N'hésite pas à revenir régulièrement sur ton <a href="https://trajectoiredroit.com/mon-compte.html" style="color:#1a237e;">espace Mon compte</a> pour retélécharger le même format que tu as déjà acheté. Tu profites ainsi de la dernière version sans rien payer de plus.
          </p>
          <p style="font-size:13px;color:#777;margin:0 0 24px;">
...
async function envoyerConfirmationStage(email, metadata, brevoKey) {
  ...
  const paragraphes = [
    ...
    "La deuxième séance se déroulera le mercredi 28 octobre, de 18 h à 21 h. Nous corrigerons un commentaire d'arrêt de A à Z, puis nous travaillerons la méthode du cas pratique : construction précise de la majeure, application de chaque condition aux faits et rédaction de la solution.",
    "Enfin, la troisième séance aura lieu le jeudi 29 octobre, de 18 h 30 à 20 h 30. Nous commencerons par la correction complète d'un cas pratique, puis nous étudierons la méthode de la dissertation juridique : recherche du plan, construction de la problématique et rédaction de l'introduction.",
