...
const PRODUITS = {
  ...
  // Cours-fiches – 24,99 €
  "cours-fiche-travail-l3-s1": { nom: "Cours complet Droit du travail L3 S1", prix: 2499, blobs: [`${BLOB}/cours-fiche-travail-l3-s1.pdf`] },
  "cours-fiche-societes-l3-s1": { nom: "Cours complet Droit des sociétés L3 S1", prix: 2499, blobs: [`${BLOB}/cours-fiche-societes-l3-s1.pdf`] },
  "cours-fiche-commercial-l3-s1": { nom: "Cours complet Droit commercial L3 S1", prix: 2499, blobs: [`${BLOB}/cours-fiche-commercial-l3-s1.pdf`] },
  "cours-fiche-procedure-penale-l3": { nom: "Cours complet Procédure pénale L3", prix: 2499, blobs: [`${BLOB}/cours-fiche-procedure-penale-l3.pdf`] },
  "cours-fiche-contrats-speciaux-l3": { nom: "Cours complet Contrats spéciaux L3", prix: 2499, blobs: [`${BLOB}/cours-fiche-contrats-speciaux-l3.pdf`] },
  "cours-fiche-obligations-l2-s2": { nom: "Cours complet Droit des obligations L2 S2", prix: 2499, blobs: [`${BLOB}/cours-fiche-obligations-l2-s2.pdf`] },
  "cours-fiche-da-l2-s2": { nom: "Cours complet Droit administratif L2 S2", prix: 2499, blobs: [`${BLOB}/cours-fiche-da-l2-s2.pdf`] },
  "cours-fiche-penal-l2-s1": { nom: "Cours complet Droit pénal L2 S1", prix: 2499, blobs: [`${BLOB}/cours-fiche-penal-l2-s1.pdf`] },
  "cours-fiche-contrats-l2-s1": { nom: "Cours complet Droit des contrats L2 S1", prix: 2499, blobs: [`${BLOB}/cours-fiche-contrats-l2-s1.pdf`] },
  "cours-fiche-da-l2-s1": { nom: "Cours complet Droit administratif L2 S1", prix: 2499, blobs: [`${BLOB}/cours-fiche-da-l2-s1.pdf`] },
  "cours-fiche-biens-l2": { nom: "Cours complet Droit des biens L2", prix: 2499, blobs: [`${BLOB}/cours-fiche-biens-l2.pdf`] },
  "cours-fiche-hist-institutions-l1": { nom: "Cours complet Histoire des institutions L1 S2", prix: 2499, blobs: [`${BLOB}/cours-fiche-hist-institutions-l1.pdf`] },
  "cours-fiche-penal-general-l1": { nom: "Cours complet Droit pénal général L1 S2", prix: 2499, blobs: [`${BLOB}/cours-fiche-penal-general-l1.pdf`] },
  "cours-fiche-famille-l1-s2": { nom: "Cours complet Droit de la famille L1 S2", prix: 2499, blobs: [`${BLOB}/cours-fiche-famille-l1-s2.pdf`] },
  "cours-fiche-constit-l1-s2": { nom: "Cours complet Droit constitutionnel L1 S2", prix: 2499, blobs: [`${BLOB}/cours-fiche-constit-l1-s2.pdf`] },
  "cours-fiche-intro-droit-l1": { nom: "Cours complet Introduction au droit L1 S1", prix: 2499, blobs: [`${BLOB}/cours-fiche-intro-droit-l1.pdf`] },
  "cours-fiche-hist-droit-l1": { nom: "Cours complet Histoire du droit L1 S1", prix: 2499, blobs: [`${BLOB}/cours-fiche-hist-droit-l1.pdf`] },
